...
namespace Hellscript
{
    public static class ContentServices
    {
        ...
        public static long PurchaseGold(HeroSave hero,int mode)=>mode==0?500L+50L*hero.highestClear:mode==1?500L*Math.Max(1,hero.highestClear):0;
        public static int PurchaseMaterials(int mode)=>mode==1?50:0;
