...
On level-up, update the number immediately and briefly emphasize only the badge. Do not add a blocking full-screen level-up dialog to this HUD scope. A maximum level exists only when explicitly supplied by growth rules.
