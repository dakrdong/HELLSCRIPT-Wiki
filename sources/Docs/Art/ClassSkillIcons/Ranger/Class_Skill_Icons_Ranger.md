...
2026-09-23에 [끝없는 추격 AP19](manifests/AP19.json)를 추가해 현재 궁수 아이콘은 37개입니다. 아래 내용은 최초 36개 제작 당시의 기록이며, 신규 아이콘의 Sprite 임포트와 HTML 반영은 [통합 제작 기록](../Class_Skill_Icons.md)에 정리했습니다.
