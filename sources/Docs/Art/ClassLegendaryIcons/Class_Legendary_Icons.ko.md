...
후속 연결: 2026-09-23에 전설 장비 이미지 141개를 공통 장비 표시에 연결했다. 현재 연결과 검증 범위는 [전설·세트 장비 이미지 연결](../../Implementation/Equipment_Art_Integration.md)에 기록하며, 아래 내용은 최초 제작 당시의 근거를 보존한다.
